<script>
function back(){
	$("#result").load("mod/mod_color/select.php");
}
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Add Data Color</h4>
      </div>
...
$('#insert').click(function(){
	...
	var datas="color_name="+color_name;
	if (color_name==""){
		alert('Form still empty!');
	}else{
		$.ajax({
			type: "POST",
			url: "mod/mod_color/action.php?add",
			data: datas
		}).done(function(data){
			$('#color_name').val('');
			back();
